...
if (msgCount === 0) {
  ...
  `);
  insertMsg.run('kobbir',     'cuz',   'Evans, you have shown us all what it means to dream big and work hard. Engineer is not just a title — it is who you are. So proud of you.');
